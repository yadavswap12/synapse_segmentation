...
# Define function for parallel implementation on images.  
def makeDataParallel(img_df, tiles_directory, ss_bb_tiles_directory, bb_tiles_directory, input_data_directory, output_data_directory, img_num, resize, sema): 
...
if __name__ == "__main__":
    ...
    if not os.path.exists(storm_exp_directory + "input_data_tiles_size_{}\\" .format(tile_size)):
        os.mkdir(storm_exp_directory + "input_data_tiles_size_{}\\" .format(tile_size))
    ...
    # Make directory to store image tiles.
    if not os.path.exists(storm_exp_directory + "output_data_tiles_size_{}\\" .format(tile_size)):
        os.mkdir(storm_exp_directory + "output_data_tiles_size_{}\\" .format(tile_size))
    ...
    for img_num in tiles_df["Num_image"].unique():
        ...
        process = multiprocessing.Process(target = makeDataParallel, args=(img_df, tiles_directory, ss_bb_tiles_directory, bb_tiles_directory, input_data_directory, output_data_directory, img_num, resize, sema))                
        jobs.append(process)
        process.start()                  
